/**
 * Slightly Modified Version of CCP's ccpwgl.js file
 *
 * Line 305 - 318 : Adds a function to get all the SOF data
 * Extra code also added to ccpwgl_int.js to make this function possible
 *
 */
...
var ccpwgl = (function (ccpwgl_int)
{
    ...
    ccpwgl.initialize = function (canvas, params)
    {
        ...
        if (!d.CreateDevice(canvas, glParams)) //{preserveDrawingBuffer:true}))//
        {
    ...
    /**
     * Gets the whole Space Object Factory file.
